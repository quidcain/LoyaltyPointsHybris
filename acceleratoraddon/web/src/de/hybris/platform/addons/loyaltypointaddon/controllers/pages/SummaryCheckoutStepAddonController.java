...
//@Controller
//@RequestMapping(value = "/checkout/multi/addon/summary")
public class SummaryCheckoutStepAddonController extends AbstractCheckoutStepController
{
	private static final Logger LOGGER = Logger.getLogger(SummaryCheckoutStepAddonController.class);
			...
			CommerceCartModificationException
	{
		...
		return LoyaltypointaddonControllerConstants.CheckoutSummaryPage;
	}
	...
	//	@Resource(name = "loyaltyPointAcceleratorCheckoutFacade")
	//	public void setLoyaltyPointAcceleratorCheckoutFacade(
	//			final LoyaltyPointAcceleratorCheckoutFacade loyaltyPointAcceleratorCheckoutFacade)
	//	{
	//		this.loyaltyPointAcceleratorCheckoutFacade = loyaltyPointAcceleratorCheckoutFacade;
	//	}
