 ...
 *
 */
package de.hybris.platform.addons.loyaltypointaddon.hmc;
 ...
 * @version ExtGen v4.1
 */
public class LoyaltypointHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(LoyaltypointHMCExtension.class.getName());
